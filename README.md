...
- 44:45 - Make an API call after every key press that if the difference between 2 API calls is <200ms, decline the API call
- 55:00 - How many times API has been called ?
- 01:03:03 - Building Youtube Search Suggestions bar
- 01:17:00 - Buildig hide and show suggestion.<br>
  `Commit - 7`
- 01:22:00 - Buildign the caching.
